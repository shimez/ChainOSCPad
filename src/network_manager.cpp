...
document.addEventListener('DOMContentLoaded',()=>{['forget-wifi-form','reset-settings-form'].forEach(id=>{const form=document.getElementById(id);if(form)form.addEventListener('submit',submitSystemForm)})});
  ...
  String legacyEncoderCard(const EncoderInputSetting &e)
  {
    ...
    h.replace("<span class='badge badge-type'>Encoder</span>", "<span class='badge badge-type'>Encoder #" + String(KEY_COUNT + 1) + "</span>");
  ...
  String encoderCard()
  {
    ...
    h.replace("<span class='badge badge-type'>Encoder</span>", "<span class='badge badge-type'>Encoder #" + String(KEY_COUNT + 1) + "</span>" + String(migration ? "<span class='badge candidate-badge'>v2 candidate</span>" : "<span class='badge v2-badge'>v2</span>"));
